...
const feedback = [
  {
    ...
    message: "Barakallahu feekum, the meat was fresh and helped our family immensely during this blessed time.",
    rating: 5,
    date: "2024-01-15",
    status: "approved",
  ...
  },
  {
    ...
    message: "Jazakallahu khair for the generous donation. May Allah reward you abundantly. The children were so happy.",
    rating: 5,
    date: "2024-01-14",
    status: "approved",
    thumbnail: null
  ...
  },
  {
    ...
    message: "Subhanallah, what a blessing! The meat was of excellent quality and the delivery was very respectful.",
    rating: 5,
    date: "2024-01-12",
    status: "approved",
    thumbnail: null
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Feedback & Testimonials</h1>
                  ...
                  <div className="flex items-center space-x-3">
                    <Avatar className="w-10 h-10">
                      ...
                      <AvatarFallback className="bg-gradient-primary text-primary-foreground text-sm">
                        {item.recipientName.split(' ').map(n => n[0]).join('')}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                      <CardTitle className="text-base">{item.recipientName}</CardTitle>
